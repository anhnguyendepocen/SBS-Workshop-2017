...
header-includes: 
   ...
   \usepackage{booktabs}
   \usepackage{caption}
    \subtitle{Session 3 -- Data Wrangling (with dplyr and tidyr)}    
...
```{r}
apply(combined.df[,c("age.group", "Sex", "Smoke.group", 
                     "Race.group", "bmi.group")], 2, table)
``` 
...
# Your turn 
```{r}
apply(combined.df[,c("Age", "Height", "Weight", 
                     "bmi", "Day1")], 2, mean)
``` 
